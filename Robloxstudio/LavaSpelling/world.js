...
export class World {
    ...
    createEnvironment() {
        ...
        const lavaGeo = new THREE.BoxGeometry(100, 1, 100);
    ...
    createSpawnPlatforms(count = 8) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            const geo = new THREE.CylinderGeometry(1.5, 1.5, 1, 16);
    ...
    triggerLava(riseUnits = 1) {
        this.lavaActive = true;
        const safeRise = Math.min(Math.max(riseUnits, 1), 4);
